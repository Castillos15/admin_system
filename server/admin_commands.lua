...
function Commands:__init ( )
	...
	self.commands =
		{
			[ "ban" ] = { action = "player.ban", args = "p,i,s-" },
			...
			[ "warp" ] = { action = "player.warp", args = "p" },
			...
			[ "giveweap" ] = { action = "player.giveweapon", args = "p,i" },
			[ "giveadmin" ] = { action = "player.giveadmin", args = "p" },
			[ "takeadmin" ] = { action = "player.takeadmin", args = "p" },
